...
if sugar_mode == 'Сахар':
  if cream_output[1] > 0:
    ...
    st.header(f'Если вы добавите к сливкам {cream_fatness}% жирности сахар в размере 150 г на 1 кг, то получите сироп жирностью {cream_fatness/ 130}%, что ниже целевой жирности {creamfat_target}%')
else:
